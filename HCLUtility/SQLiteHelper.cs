...
namespace HCLUtility
{
    /// <summary>
    /// SQLite数据库帮助类
    /// 链接字符串<add name="conSQLite" connectionString=\"App_Data\Demo.db;Pooling=True;FailIfMissing=false; Max Pool Size=512; Min Pool Size=5"/>
    /// </summary>
     public class SQLiteHelper
    {
        private static string connectionstring = "Data Source=" + HttpRuntime.AppDomainAppPath + System.Configuration.ConfigurationManager.ConnectionStrings["conSQLite"].ConnectionString;
